...
public class Test {
 ...
 //      1) CSV 파일로부터 테이블 객체 생성
         Database.createTable(new File("project/rsc/authors.csv"));
         Database.createTable(new File("project/rsc/editors.csv"));
         Database.createTable(new File("project/rsc/translators.csv"));
         Database.createTable(new File("project/rsc/books.csv"));
